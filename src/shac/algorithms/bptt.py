...
class BPTT:
    def __init__(self, cfg):
        ...
        self.env = env_fn(
            ...
            MM_caching_frequency=cfg["params"]["diff_env"].get(
    ...
    def train(self):
        ...
        for epoch in range(self.max_epochs):
            ...
            print(
                "iter {}: ep loss {:.2f}, ep discounted loss {:.2f}, ep len {:.1f}, fps total {:.2f}, grad norm before clip {:.2f}, grad norm after clip {:.2f}".format(
                    self.iter_count,
                    mean_policy_loss,
                    mean_policy_discounted_loss,
                    mean_episode_length,
