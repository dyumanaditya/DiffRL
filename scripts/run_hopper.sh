...
#  python train.py alg=shac env=hopper general.seed=$seed env.shac.max_epochs=1000 general.logdir=ShacLowHighStiffness1000
#done
...
#    general.logdir=ShacLowHighStiffness1000
#done
